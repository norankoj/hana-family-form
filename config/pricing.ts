...
export const PRICING: Record<Department, Record<RegistrationType, PriceGrid>> = {
  ...
  JOYLAND: {
    ...
    DAILY:   { NON_LODGING: 30_000, LODGING: 30_000 },
  },
  KINDER: {
    EARLY:   { NON_LODGING: 45_000, LODGING: 50_000 },
    REGULAR: { NON_LODGING: 50_000, LODGING: 55_000 },
    ONSITE:  { NON_LODGING: 55_000, LODGING: 60_000 },
