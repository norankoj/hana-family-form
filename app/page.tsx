          ...
          <div className="rounded-2xl bg-white border border-slate-200 overflow-hidden">
            ...
            {feeOpen && (
              <div className="px-6 pb-6 flex flex-col gap-5">
                ...
                {/* 숙박 안내 */}
                <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-4 flex flex-col gap-3 text-sm text-amber-900 leading-relaxed">
                  <p>
                    수양회 참석인원이 많아 부득이하게{" "}
                    <strong>다음에 해당하는 성도분들만</strong> 숙박하실 수
                    있습니다. 그 외의 성도분들은 <strong>비숙박을 원칙</strong>
                    으로 합니다.
                  </p>
                  <p>
                    방 배정은 기본적으로 <strong>1실 8인</strong>으로 형제,
                    자매로 나눠 배정합니다.
                  </p>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="rounded-xl border border-slate-200 overflow-hidden">
                    ...
                    <div className="grid grid-cols-2 divide-x divide-slate-200">
                      ...
                      <div className="px-4 py-3 text-center">
                        <span className="inline-block rounded-full bg-emerald-100 px-2.5 py-0.5 text-xs font-semibold text-emerald-700 mb-2">
                          ~12개월
                        </span>
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-2">
                    {[
                      {
                        badge: "자녀 3명 이상",
                        discount: "부모 + 자녀 전원 10% 할인",
                      },
                      {
                        badge: "자녀 4명 이상",
                        discount: "부모 + 자녀 전원 15% 할인",
                      },
                    ].map((item) => (
                      <div key={item.badge} className="flex items-center gap-3">
                        <span className="shrink-0 rounded-full bg-emerald-100 px-2.5 py-0.5 text-sm font-bold text-emerald-700">
                          {item.badge}
                        </span>
